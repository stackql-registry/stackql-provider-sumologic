...
<tr><td><b>Id</b></td><td><CopyableCode code="sumologic.parsers.search" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Path of the folder or parser. (example: /Parsers/SampleFolder/TestParser)</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>Search for a folder or parser in the cloud SIEM parsers library structure.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-limit">
    ...
    <td>Maximum number of items you want in the response.</td>
</tr>
<tr id="parameter-offset">
    <td><CopyableCode code="offset" /></td>
    <td><code>integer (int32)</code></td>
    <td>The position or row from where to start the search operation.</td>
</tr>
</tbody>
</table>
