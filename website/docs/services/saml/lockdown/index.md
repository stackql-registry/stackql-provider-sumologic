...
Creates, updates, deletes, gets or lists a <code>lockdown</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="lockdown" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="sumologic.saml.lockdown" /></td></tr>
</tbody></table>
...
```sql
EXEC sumologic.saml.lockdown.enable 
...
```sql
EXEC sumologic.saml.lockdown.disable 
@region='{{ region }}' --required unless SUMOLOGIC_ENVIRONMENT is set
;
```
</TabItem>
