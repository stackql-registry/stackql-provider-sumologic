...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="pending_update_request" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="sumologic.account.pending_update_request" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The date on which the update request was created. (wire: createdOn)</td>
</tr>
<tr>
...
created_on,
plan
FROM sumologic.account.pending_update_request
...
```sql
DELETE FROM sumologic.account.pending_update_request
WHERE region = '{{ region }}' --required unless SUMOLOGIC_ENVIRONMENT is set
;
```
</TabItem>
